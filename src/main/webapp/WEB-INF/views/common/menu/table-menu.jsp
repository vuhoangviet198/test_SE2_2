...
<body>
	<header>
		<ul>
			...
			<li class="click-menu"><a href='<c:url value="/table"></c:url>'
				class="menu-click">Quản lý đặt bàn</a></li>
			<li><a href='<c:url value="/order-dish"></c:url>'
				class="menu-non-click">Quản lý giao hàng</a></li>
			<li><a href='<c:url value="/table-order"></c:url>'
				class="menu-non-click">Đơn đặt bàn</a></li>
		</ul>
	</header>
