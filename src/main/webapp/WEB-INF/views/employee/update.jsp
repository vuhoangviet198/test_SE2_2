	...
	$(document)
			.ready(
					function() {
						...
						$('img')
								.attr("src",
										"<c:url value='/assets/images/"+ nameImage +"'></c:url>");
					})
</script>
<!-- END -->
<body>
	...
	<div class="container demo">
		<c:url value="/employee-update-process/${code}" var="create"></c:url>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<form:select path="blockStatus" cssClass="form-control">
								<form:option value="false">Mở khóa</form:option>
								<form:option value="true">Khóa</form:option>
							</form:select>
						</div>
					</div>
				</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							<div class="input-group">
								<span class="btn btn-secondary btn-file">Photo<input
